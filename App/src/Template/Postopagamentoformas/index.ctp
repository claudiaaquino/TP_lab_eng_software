    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions"><?= $this->Form->postLink(__('Deletar'), ['action' => 'delete', $postoPagamentoForma->id], ['confirm' => __('Tem certeza que deseja deletar esse registro # {0}?', $postoPagamentoForma->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
