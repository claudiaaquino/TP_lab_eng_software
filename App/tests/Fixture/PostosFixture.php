 ...
 *
 */
class PostosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'dt_cadastro' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'dt_cadastro' => '2016-10-13 03:46:10',
            'dt_modificado' => 1476330370,
            'status' => 1
        ],
    ];
}
